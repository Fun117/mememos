        ...
        <div className="border-t border-[#FFFFFF]/[0.16] bg-zinc-950/20 pt-20 pb-10 px-4 overflow-hidden z-50">
            <div className="flex md:flex-row flex-col w-full max-w-7xl mx-auto justify-between relative">
                ...
                <div className="lg:w-[50%] flex flex-col">
                    <div className='mb-5'>
                        <a className="flex items-center space-x-2 flex-shrink-0 z-50 select-none" href={links_config.site_url_home}>
                            <img alt="Sglid" loading="lazy" width={10}  height={10} decoding="async" data-nimg={1} className="transition duration-300 transform blur-0 scale-100 h-5 w-5 pointer-events-none" src={links_config.imgUrl_mememos_512x512}/>
                    ...
                    <div className='mb-2'>
                        ...
                        <div className="flex space-x-2 mt-1">
                            <a href={links_config.fun117_link_github} target="_blank"  rel="noopener noreferrer" className="font-normal flex items-center text-white/[0.64] hover:text-white/[0.84] transition duration-200">
                                <FontAwesomeIcon icon={faGithub} />
                            </a>
                            <a href={links_config.fun117_link_youtube} target="_blank"  rel="noopener noreferrer" className="font-normal flex items-center text-white/[0.64] hover:text-white/[0.84] transition duration-200">
                ...
                <div className="grid grid-cols-2  md:flex">
                    <div className="flex flex-col text-sm md:px-4 mb-4">
                        ...
                        <a href={links_config.site_url_about} rel="noopener noreferrer" className="font-normal mt-4 text-white/[0.64] hover:text-white/[0.84] transition duration-200">
                        About
                        </a>
                    </div>
                    <div className="flex flex-col text-sm md:px-4 mb-4">
